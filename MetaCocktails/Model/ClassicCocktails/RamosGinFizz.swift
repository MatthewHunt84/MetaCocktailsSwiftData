...
let ramosGinFizz = Cocktail(name: "Ramos",
                            background: BackgroundColor.blue,
                            garnish: Garnish(name: "Orange Peel", imageAsset: Image(systemName: "circle.fill")),
                            spec: [CocktailIngredient(name: Ingredient.gin, value: 2.0, unit: MeasurementUnit.fluidOunces)],
                            flavor: SearchTags.Flavor.cream)
