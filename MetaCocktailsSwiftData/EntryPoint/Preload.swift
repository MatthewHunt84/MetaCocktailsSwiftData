...
enum Preload: CaseIterable {
    ...
    var cocktails: [Cocktail] {
        switch self {
        case .classicCocktails:
            [adonis, airMail, alaska, alexanderCocktail, alexandre, algonquin, amarettoSour, americano, aperolSpritz, appleJackCocktail, armyNavy, aviation, beesKnees, betweenTheSheets, bamboo, bijou, bloodAndSand, bloodyMary, blueBlazer, bobbyBurns, boulevardier, bramble, brandyAlexander, brandyCrusta, brownDerbyRum, brownDerbyBourbon, brooklyn, brunelle, bizzyIzzyHighball, caipirinha, carajillo, champsElysees, champagneCocktail, chocolateCocktail, chrysanthemum, cloverClub, cornNOil, corpseReviver1, corpseReviver2, cosmopolitan, daiquiri, daiquiriNo4OG, darkNStormy, deathInTheAfternoon, diamondBack, elDiablo, elPresidente, emerald, fairAndWarmer, fancyFree, fogCutter, french75, french75Cognac, ginRickey, gimlet, gimletMcElhone, ginFizz, silverGinFizz, grasshopper, hankyPanky, harveyWallbanger, hemingwayDaiquiri, papaDobleWnG, homeOnTheRange, honeymoonCocktail1st, honeymoonCocktailEmbury, hollandHouseKappeler, hollandHouseCocktail, hotBrandyToddy, morgenthalersToddy, hotelNacional, hurricane, irishCoffee, jackRose, japaneseCocktail, jungleBird, kirRoyale, laLouisiane, lastWord, lemonDrop, lionsTail, manhattan, maiTai, majorBailey, margarita, margaritaTommys, martinez, martinezWnG, martini, gibson, mexicanFiringSquad, mezcalero, mintJulep, mojito, modernCocktail, morningGloryFizz, moscowMule, negroni, NewYorkSour, oldFashioned, oldCuban, oldPal, painKiller, paloma, peguClub, peguClubSavoy, pimmsCup, pinkLady, piscoSour, princeEdward, queensParkSwizzle, ramosGinFizz, ramonaFlowers, rememberTheMaine, robRoy, saturn, sazerac, scofflaw, sherryCobbler, sidecar, singaporeSling, sloeGinFizz, southSideFizz, talentScout, tiPunch, tipperary, tipperaryDR, tomCollins, toronto, twentiethCenturyCocktail, vesper, vieuxCarre, wardEight, whiskeySmash, whiskeySour, zombie]
            
        case .modernCocktails:
            [blackManhattan, cableCar, casanovaCocktail, caucasian, eastSide, greenpoint, jasmine, prizefighterNo1, trinidadSour, ultimaPalabraLondon, whiteLinen, whiteNegroni]
            
        case .williamsAndGrahamClassicCocktails:
            [airMailWnG, alaskaWnG, algonquinWnG, amarettoSourWnG, americanoWnG, betweenTheSheetsWnG, bambooWnG, bijouWnG, bloodAndSandWnG, bloodyMaryWnG, boulevardierWnG, brandyAlexanderWnG, brambleWng, brandyCrustaWnG, brownDerbyWnG, brooklynWnG, chocolateMartiniWnG, cloverClubWnG, elksClubWnG, elPresidenteWnG, espressoMartiniWnG, fairAndWarmerWnG, fancyFreeWnG, fogCutterWnG, french75WnG, ginFizzWnG, grasshopperWnG, hankyPankyWnG, honeymoonCocktailWnG, hollandHouseCocktailWnG, hotToddyWnG, hotelNacionalWnG, hurricaneWnG, irishCoffeeWnG, japaneseCocktailWnG, jungleBirdWnG, kirRoyaleWnG, laLouisianeWnG, lastWordWnG, lemonDropWnG, maiTaiWnG, majorBaileyWnG, martinezWnG, mexicanFiringSquadWnG, mintJulepWnG, mojitoWnG, modernCocktailWnG, morningGloryFizzWnG, NewYorkSourWnG, oldFashionedWnG, oldCubanWnG, oldPalWnG, painKillerWnG, piscoSourWnG, queensParkSwizzleWnG, rememberTheMaineWnG, RustyNailWnG, robRoyWnG, saturnWnG, sazeracWnG, scofflawWnG, sherryCobblerWnG, sidecarWnG, singaporeSlingWnG, sloeGinFizzWnG, stingerWnG, tiPunchWnG, tipperaryWnG, tomCollinsWnG, vesperWnG, zombieWnG]
