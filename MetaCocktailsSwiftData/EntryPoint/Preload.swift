...
enum Preload: CaseIterable {
    ...
    var cocktails: [Cocktail] {
        ...
        case .deathAndCoCocktails:
            [conference, cropTop, divisionBell, finalWard, gilda, nakedAndFamous, silverMonk]
