...
enum Preload: CaseIterable {
    ...
    var cocktails: [Cocktail] {
        ...
        case .milkAndHoney:
            [americanTrilogy, appleJackMnH, bensonhurst, calvados75, cobbleHill, cosmonaut, debbieDont, deepBlueSea, fallbackCocktail, ginAndIt, goldRush, homeOnTheRangeMnH, kentuckyMaid, leftHand, penicillin, redHookCocktail, savoirFaire, siGuey, springForward, tattletale, theBusiness, thirtyEightSpecial ]
        }
    }
}
