...
enum Preload: CaseIterable {
    ...
    var cocktails: [Cocktail] {
        ...
        case .milkAndHoney:
            [americanTrilogy, appleJackMnH, bensonhurst, calvados75, cobbleHill, cosmonaut,daiquiriMnH, daiquiriNo4MnH, debbieDont, deepBlueSea, eastSideCocktail, fallbackCocktail, frescaPlatino, gabriella, ginAndIt, gingerCocktail, goldRush, gordonsBreakfast, gordonsCup, harvestOldFashioned, homeOnTheRangeMnH, holeInTheCup, jFKHarris, kentuckyMaid, leftHand, southSideCocktail, oaxacanite, paperPlane, penicillin, piscoSourMnH, regalAmburana, redHookCocktail, ryeHummingbirdDown, saladito, savoirFaire, siGuey, springForward, streetAndFlynnSpecial, sugarplum, suttersMill, tattletale, theBusiness, thirtyEightSpecial, theMedicinaLatina, theSeaPlane]
        }
    }
}
