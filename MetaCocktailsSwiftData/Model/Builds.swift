...
let cafeConLecheFlipBuild = Build(instructions: [Instruction(step: 1, method: "Add all ingredients into a tin a dry shake to emulsify"),
                                                 ...
                                                 Instruction(step: 3, method: "Immediately after shaking, pop the tin and double strain into a flip glass. (In Sasha Petraske's 'Regaurding Cocktails', is says to use a 'chilled sour glass')"),
