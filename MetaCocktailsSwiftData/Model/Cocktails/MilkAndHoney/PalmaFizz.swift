...
var palmaFizzSpec  = [CocktailIngredient(.juices(.lime), value: 0.5),
                      CocktailIngredient(.otherNonAlc(.roseWater), value: 3, unit: .drops),
                      CocktailIngredient(.vodkas(.vodkaAny), value: 2),
                      CocktailIngredient(.soda(.gingerBeer) , value: 5)]
