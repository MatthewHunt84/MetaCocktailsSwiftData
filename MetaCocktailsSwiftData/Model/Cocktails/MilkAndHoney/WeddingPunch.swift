...
var weddingPunchBuild = Build(instructions: [Instruction(step: 1, method: "Combine the liqueur, vermouth, and prosecco in a punch bowl large enough to hold an 8-inch (20 cm) square block of ice."),
