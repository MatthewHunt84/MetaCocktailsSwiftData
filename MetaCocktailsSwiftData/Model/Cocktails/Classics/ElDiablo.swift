...
var elDiabloBuildOrder = Build(instructions: [Instruction(step: 1, method: "Shake everything but the ginger ale with ice."),
                                              Instruction(step: 1, method: "Strain into a collins glass full of ice and top the ginger ale. You can choose to build this cocktail instead if you're feeling like a dirt bag.")])
