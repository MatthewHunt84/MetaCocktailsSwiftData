...
let ramonaFlowersSpec: [OldCocktailIngredient] = [OldCocktailIngredient(.syrups(.simple), value: 0.5, prep: PrepBible.simpleSyrupPrep),
...
let ramonaFlowersTags = Tags(flavors: [.lime],
                             profiles: [.herbal, .refreshing, .floral, .light],
                             styles: [.sour, .shaken])
