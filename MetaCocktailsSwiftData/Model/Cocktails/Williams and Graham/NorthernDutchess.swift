...
var northernDuchessSpec  = [OldCocktailIngredient(.syrups(.demSyrupOneToOne), value: 1, unit: .barSpoon, prep: PrepBible.demSyrupPrep),
...
var northernDuchessTags = Tags(flavors: [.lemon],
                               profiles: [.complex, .punchy],
