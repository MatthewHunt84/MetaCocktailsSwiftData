...
enum MeasurementUnit: String, Codable, CaseIterable {
    ...
    case float              = "Float"
    case fluidOunces        = "oz."
    case fluidOuncesFloated = "oz. (floated)"
    ...
    case none               = ""
    case peel               = "Peel(s)"
    case peeledAndJuiced    = "Peeled and juiced"
    case pinch              = "Pinch"
    case slices             = "Slices"
    case sliceOf            = "Slice of"
    case splash             = "Splash of"
    case spraysInGlass      = "Sprays"
    case spritzOnTop        = "Finish spritz with"
