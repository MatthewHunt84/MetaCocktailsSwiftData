...
enum AuthorPlaces: String, Codable, CaseIterable, Identifiable {
    ...
    case cafeRoyalCocktailBook        = "Cafe Royal Cocktail Book (London)"
    ...
    case harryJohnsonManual           = "Harry Johnson's New and Improved Bartender's Manual"
