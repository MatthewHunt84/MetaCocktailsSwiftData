...
var queensParkSpec = [CocktailIngredient(name: Ingredient.mint, value: 10, unit: .leaves), 
                      CocktailIngredient(name: Ingredient.lime, value: 0.75, unit: .fluidOunces),
                      CocktailIngredient(name: Ingredient.richDem, value: 0.5, unit: .fluidOunces),
                      CocktailIngredient.init(name: Ingredient.demeraraRum, value: 2, unit: .fluidOunces),
                      CocktailIngredient(name: Ingredient.angosturaBitters, value: 5, unit: .dashes) ]
