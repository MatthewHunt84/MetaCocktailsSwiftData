...
var caipirinhaSpec = [CocktailIngredient(name: .lime, value: 2, unit: .limeQuarters),
                      CocktailIngredient(name: .granulatedSugar , value: 1.5, unit: .teaspoons),
                      CocktailIngredient(name: .cachaca, value: 2, unit: .fluidOunces)]
...
var caipirnhaTags  = Tags(flavors: [.lime],
                          profiles: [.sweet, .citrusy, .fruity],
                          textures: [.light, .grainy],
                          styles: [.sour, .shaken],
                          baseComponents: [.cachaca])
