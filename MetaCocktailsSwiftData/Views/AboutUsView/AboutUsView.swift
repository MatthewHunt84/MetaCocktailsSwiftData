                ...
                ScrollView(showsIndicators: false) {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        HStack {
                            ...
                            Text("Transitioning from building drinks to building software has been an amazing journey, and we're not finished yet. Have ideas for new features? We'd love to hear them! cocktailcopilot@gmail.com")
