...
final class CocktailListViewModel: ObservableObject {
    ...
    @Published var cocktails: [Cocktail] = [aperolSpritz, bamboo, beckyWithTheGoodHair, blackberrySageSmash, boulevardier, caipirinha, cloverClub, cominUpRoses, cosmopolitan, cropTop, daiquiri, divisionBell, elPresidente, emerald, finalWard, french75, french75Cognac, gimlet, ginFizz, jungleBird, lastWord, manhattan, maiTai, margarita, margaritaTommys, martini, mintJulep, mojito, negroni, paloma, piscoSour, paperPlane, penicillin, queensParkSwizzle, ramosGinFizz, robRoy, saturn, sazerac, sunnySide, trinidadSour, twentiethCenturyCocktail, ultimaPalabra, whiskeySour, whiteNegroni]
