...
final class PrepBible{
    ...
    static let richDem = Prep(prepIngredientName: "Rich Demerara syrup",
                              prepRecipe:[Instruction(step: 1, method: "Combine two parts Demerara sugar to one part water into a pot."),
    ...
    static let simpleSyrupPrep = Prep(prepIngredientName: "Simple syrup",
                                      prepRecipe:[Instruction(step: 1, method: "Combine one part sugar to one part water into a pot."),
    ...
    static let demSyrupPrep = Prep(prepIngredientName: "Demerara syrup",
                                   prepRecipe:[Instruction(step: 1, method: "Combine one part Demerara sugar to one part water into a pot."),
                                               Instruction(step: 2, method: "Bring to a boil and then immediately take off heat."),
                                               Instruction(step: 3, method: "Let cool before bottling.")]   )
    ...
    static let cucumberSyrup = Prep(prepIngredientName: "Cucumber syrup",
                                    prepRecipe:[Instruction(step: 1, method:  "Make a rich simple syrup (2 parts sugar to 1 part water, weighed out) and let cool down completely"),
    ...
    static let orgeat = Prep(prepIngredientName: "Orgeat",
                             prepRecipe: [Instruction(step: 1, method:  "Makes 300ml - (Milk and Honey Recipe)."),
    ...
    static let raspberrySyrup = Prep(prepIngredientName: "Raspberry syrup",
                                     prepRecipe: [Instruction(step: 1, method:  "Weigh out one part raspberries to two parts sugar and add them to a pot."),
    ...
    static let richSimple = Prep(prepIngredientName: "Rich simple syrup",
                                 prepRecipe:[Instruction(step: 1, method: "Weigh out two parts sugar to one part water and combine in a pot."),
                                             Instruction(step: 2, method: "Bring to a boil and then immediately take off heat."),
                                             Instruction(step: 3, method: "Let cool before bottling.")])
    ...
    static let violetteSyrup = Prep(prepIngredientName: "Violette syrup",
                                    prepRecipe:[Instruction(step: 1, method: "Add 2oz.(60ml) gin, 1oz.(30ml) violet syrup such as Monin, and 1oz.(30ml) simple syrup together."),
    ...
    static let mineralSaline = Prep(prepIngredientName: "Mineral saline",
                                    prepRecipe: [Instruction(step: 1, method: "Add 68g of kosher salt to 1 liter of mineral water, warmed."), Instruction(step: 2, method: "Keep refrigerated for up to a month.")])
    
    static let gommeSyrup = Prep(prepIngredientName: "Gonmme syrup",
    ...
    static let whitePeachPuree = Prep(prepIngredientName: "White peach puree",
                                      prepRecipe: [Instruction(step: 1, method: "Combine 1 white peach, skin left on, pitted and sliced, 1 oz (30 ml) fresh Meyer lemon juice, and 1 oz (30 ml) simple syrup in a food processor and purée."),
    ...
    static let cinnamonSyrup = Prep(prepIngredientName: "Cinnamon syrup",
                                    prepRecipe: [Instruction(step: 1, method: "Combine 250g of water, 250g of white sugar, and three to four cinnamon sticks into a pot."),
                                                 Instruction(step: 2, method: "Heat on a stove top until it comes to a boil and immediately turn the heat off."),
    ...
    static let vanillaSyrup = Prep(prepIngredientName: "Vanilla syrup",
                                   prepRecipe: [Instruction(step: 1, method: "Combine 250g of water, 250g of white sugar, and one whole vanilla bean (or 1 tablespoon vanilla extract or vanilla bean paste but these options are not preferred) into a pot."),
                                                Instruction(step: 2, method: "Heat on a stove top until it comes to a boil and immediately turn the heat off."),
    ...
    static let grenadine = Prep(prepIngredientName: "Grenadine",
                                prepRecipe: [Instruction(step: 1, method: "Combine 500g each of fresh pomegranate juice (or POM) and white sugar into a pot."),
    ...
    static let passionfruitSyrupPrep = Prep(prepIngredientName: "Passionfruit syrup",
                                            prepRecipe: [Instruction(step: 1, method: "Combine 500g each of fresh passionfruitPulp, white sugar, and water into a pot."),
