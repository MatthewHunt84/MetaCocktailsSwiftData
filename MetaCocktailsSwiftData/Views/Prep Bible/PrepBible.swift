...
final class PrepBible{
    ...
    static let hibiscusSyrupPrep = Prep(prepIngredientName: "Hibiscus syrup",
                                        prepRecipe:[Instruction(step: 1, method: "Add 5g dried hibiscus flowers to 500g water and bring to a boil"),
                                                    Instruction(step: 2, method: "Add 500g turbinado sugar"),
