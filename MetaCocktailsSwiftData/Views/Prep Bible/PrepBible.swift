...
final class PrepBible{
    ...
    static let richCinnamonAndVanillaSyrupPrep = Prep(prepIngredientName: "Rich cinnamon and vanilla syrup", prepRecipe: [Instruction(step: 1, method: "Combine 150g of water, 300g of white sugar, one whole vanilla bean (or 1 tablespoon vanilla extract or vanilla bean paste but these options are not preferred), and three cinnamon sticks into a pot."),
    ...
    static let grapefruitShrub = Prep(prepIngredientName: "Grapefruit shrub", prepRecipe: [Instruction(step: 1, method:  "For 500ml: Add 250g white sugar to 150g grapefruit peels."),
    ...
    static let cinnamonSyrup = Prep(prepIngredientName: "Cinnamon Syrup", prepRecipe: [Instruction(step: 1, method: "Combine 250g of water, 250g of white sugar, and three to four cinnamon sticks into a pot."),
                                                                                       Instruction(step: 2, method: "Heat on a stove top until it comes to a boil and immediately turn the heat off."),
    ...
    static let vanillaSyrup = Prep(prepIngredientName: "Vanilla Syrup", prepRecipe: [Instruction(step: 1, method: "Combine 250g of water, 250g of white sugar, and one whole vanilla bean (or 1 tablespoon vanilla extract or vanilla bean paste but these options are not preferred) sticks into a pot."),
                                                                                     Instruction(step: 2, method: "Heat on a stove top until it comes to a boil and immediately turn the heat off."),
    ...
    static let jasmineTeaInfusedGin = Prep(prepIngredientName: "Jasmine tea infused gin", prepRecipe:[Instruction(step: 1, method:"Add 45g of Jasmine tea to one 750ml bottle of Woody Creek gin."),
                                                                                                      Instruction(step: 2, method: "Shake after 30 min"),
                                                                                                      Instruction(step: 2, method: "strain after an hour and twenty minutes")] )
    
    static let grenadine = Prep(prepIngredientName: "Grenadine", prepRecipe: [Instruction(step: 1, method: "Combine 500g each of fresh pomegranate juice (or POM) and white sugar into a pot."),
