...
extension View {
    func gradientNavigationTitle(_ title: String, colors: [Color] = [.blue, .purple, .red], startPoint: UnitPoint = .leading, endPoint: UnitPoint = .trailing) -> some View {
        self.modifier(GradientNavigationTitle(title, colors: colors, startPoint: startPoint, endPoint: endPoint))
    }
}
